...
export const STORAGE_KEY = 'koalafrog-hq:workspace:v6'
...
type PhaseThreeState = Omit<FormulaState, 'labBatches'|'labBatchLines'|'labBatchAllocations'|'processSteps'|'labObservations'|'testers'|'testTemplates'|'testSessions'|'testResponses'>
