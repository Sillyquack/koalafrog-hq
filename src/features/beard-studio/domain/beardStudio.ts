import type {BeardLengthZone,BeardLogEntry,BeardLogSnapshot,BeardProfile,BeardStudioState,BeardTrimSession,BeardZoneName,GroomingProductReference,GroomingTool,TrimRecipe,TrimRecipeStep}from'../../../types/beardStudio'
export type{BeardLengthMap,BeardLengthZone,BeardLogEntry,BeardLogSnapshot,BeardProfile,BeardStudioState,BeardTrimSession,BeardZoneName,GroomingProductReference,GroomingProductRole,GroomingTool,TrimRecipe,TrimRecipeStep}from'../../../types/beardStudio'
...
export const emptyBeardStudioState = (): BeardStudioState => ({ revision:0,profiles: [], lengthMaps: [], tools: [], recipes: [], sessions: [], logs: [] })
...
export function createStarterWorkspace(): BeardStudioState {
  ...
  return {revision:0,profiles: [profile], tools: [tool], lengthMaps: [{ id: id(), profileId, zones, createdAt: timestamp, updatedAt: timestamp }], recipes: [recipe], sessions: [], logs: [] }
}
