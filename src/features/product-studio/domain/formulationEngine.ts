...
export const productTemplates={
  ...
  foot_care:{id:'foot_care',displayName:'Foot Care',description:'A research-first Foot Care workflow grounded in owned benchmark evidence and deliberate Procurement requirements.',archetypeId:'emulsion',route:'/product-studio/foot-care',targetFields:['development intent','benchmark evidence','physical system','claim guardrails','sourcing requirements'],evaluationDimensions:['benchmark evidence quality','source conflicts','functional architecture','claim risk','sourcing readiness'],defaultPhases:[],draftProcess:[],packagingIntent:'Undecided until formulation architecture review',productCategory:'Foot Care',guidance:['Emulsion, water-based and alcohol-based Foot Care systems remain planned rather than operational.','Aerosol architecture requires separate packaging, production and Compliance review.','Benchmark evidence informs functions and sourcing targets; it is not a copied composition.']},
