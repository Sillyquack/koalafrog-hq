...
describe('procurement interchange',()=>{
  ...
  it('defaults purchasing intelligence collections for older v1 exports',()=>{const legacy={version:1,exportedAt:'2026-07-25',requests:[],requestedItems:[],offers:[],recommendations:[]};expect(parseProcurementJson(JSON.stringify(legacy))).toMatchObject({supplierDiscounts:[],supplierShippingRules:[],cartScenarios:[],cartScenarioItems:[]})})
