...
export function ProcurementPage(){
 ...
 return <div className="procurement-workspace">
  <PageHeader eyebrow="Sourcing / owner-controlled research" title="Procurement" description="Structure needs, compare supplier offers and record recommendations. This workspace never places orders or makes payments." action={<><Link className="button ghost" to="/procurement/draft-plans/new"><Plus size={14}/>Create Draft Purchase Plan</Link><Link className="button ghost" to="/procurement/production-readiness"><ShoppingCart size={14}/>Production readiness</Link><button className="button primary" onClick={()=>setCreating(x=>!x)}><Plus size={14}/>New request</button></>}/>
