...
describe('procurement offer calculations',()=>{
  it('includes the structured tax/duty estimate in complete landed cost',()=>{expect(calculateOffer(item,offer)).toMatchObject({normalizedUnitPrice:.2,quantityRequired:1200,purchaseQuantity:3,productSubtotal:300,knownLandedTotal:365,estimatedLandedTotal:365,effectiveLandedUnitCost:365/1500,surplusQuantity:300})})
