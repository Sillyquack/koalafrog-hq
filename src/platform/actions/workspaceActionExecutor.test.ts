...
describe('workspace application actions', () => {
  it('inventories all 72 provider mutations without duplicates', () => {
    expect(workspaceActionNames).toHaveLength(72)
    expect(new Set(workspaceActionNames).size).toBe(72)
  })
