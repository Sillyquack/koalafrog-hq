...
const safeDiagnostic = {
  ...
  providerTrace: {
    stage: 'provider_timeout_triggered', failureClassification: 'PROVIDER_TIMEOUT_RESPONSE_HEADERS',
    timeoutSource: 'application_deadline', timeoutBudgetMs: 110000, providerElapsedMs: 110001,
    edgeFunctionElapsedMs: 111000, requestDispatched: true, responseHeadersReceived: false,
    responseBodyCompleted: false, httpStatusClass: null, abortSignalAborted: true,
    abortReasonCode: 'application_deadline', transportErrorCategory: null,
    providerRequestIdPresent: false, responsePresent: false, usagePresent: false,
  },
  attemptCount: 1,
