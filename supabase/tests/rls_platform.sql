...
select has_table('public','supplier_document_records','structured supplier documents exist');
select has_column('public','supplier_document_records','capability_state','supplier document capability is explicit');
