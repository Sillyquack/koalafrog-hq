...
execFileSync('npx',['vitest','run','--maxWorkers=1','src/features/packaging-run/data/packagingRun.integration.test.ts'],{
  stdio:'inherit',
  env:{...process.env,VITE_SUPABASE_URL:url,VITE_SUPABASE_PUBLISHABLE_KEY:anon,VITE_SUPABASE_TEST_URL:url,VITE_SUPABASE_TEST_ANON_KEY:anon,VITE_SUPABASE_TEST_SERVICE_ROLE_KEY:service},
})
