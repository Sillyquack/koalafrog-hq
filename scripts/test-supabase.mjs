...
execFileSync('npx',['vitest','run','src/platform/repository/relationalMigration.integration.test.ts','src/platform/security/securityStorage.integration.test.ts'],{stdio:'inherit',env:{...process.env,VITE_SUPABASE_URL:url,VITE_SUPABASE_PUBLISHABLE_KEY:anon,VITE_SUPABASE_TEST_URL:url,VITE_SUPABASE_TEST_ANON_KEY:anon,VITE_SUPABASE_TEST_SERVICE_ROLE_KEY:service}})
